...
go_glm_and_deepseek - GLM-5.2 (opencode Go) + DeepSeek V4 Flash (opencode Go)
...
zai_and_go_deepseek - GLM-5.2 (z.AI) + DeepSeek V4 Flash (opencode Go)
zai_and_go_minimax - GLM-5.2 (z.AI) + MiniMax M3 (opencode Go)
zai_and_go_qwen - GLM-5.2 (z.AI) + Qwen3.7 Plus (opencode Go)
