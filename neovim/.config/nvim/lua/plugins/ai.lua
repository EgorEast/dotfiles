...
return {
  ...
  -- https://github.com/magicalne/nvim.ai?tab=readme-ov-file#config
  -- {
  --   "magicalne/nvim.ai",
  --   version = "*",
  --   dependencies = {
  ...
  --   },
  --   opts = {
  --     provider = "ollama", -- You can configure your provider, model or keymaps here.
  --     gemini = {
  ...
  --     ollama = {
  --       ["local"] = true,
  --       model = "deepseek-coder-v2", -- You can start with smaller one like `gemma2` or `llama3.1`
  --       endpoint = "http://192.168.2.47:11434", -- In case you access ollama from another machine
  --     },
  --     keymaps = {
  --       toggle = "<leader>ccc", -- Toggle chat dialog
