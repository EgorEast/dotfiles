...
alias m='cmus'
alias matrix_setup_all_ansible='ansible-playbook -i inventory/hosts setup.yml --tags=setup-all,start --vault-password-file ~/.ansible-vault-pass'
alias matrix_update_all_ansible='just roles && matrix_setup_all_ansible'
alias mkdir='mkdir -p'
alias mm='mmtui'
