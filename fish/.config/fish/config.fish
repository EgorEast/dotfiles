...
alias 'z..'='z ../'
alias ZZ='exit'
alias ansible_clear_docker_images='just run-tags run-docker-prune'
alias ansible_install_all='just install-all --vault-password-file=~/.ansible-vault-pass'
alias ansible_setup_all='just setup-all --vault-password-file=~/.ansible-vault-pass'
alias ansible_update_roles='just roles'
...
alias opencode_go_glm_and_deepseek_profile='ocx oc -p go_glm_and_deepseek'
alias opencode_go_glm_and_free_profile='ocx oc -p go_glm_and_free'
alias opencode_go_glm_and_qwen_profile='ocx oc -p go_glm_and_qwen'
alias opencode_go_glm_minimax_profile='ocx oc -p go_glm_minimax'
alias opencode_go_lite_and_free_profile='ocx oc -p go_lite_and_free'
alias opencode_go_lite_profile='ocx oc -p go_lite'
...
alias opencode_zai_and_go_deepseek_profile='ocx oc -p zai_and_go_deepseek'
alias opencode_zai_and_go_minimax_profile='ocx oc -p zai_and_go_minimax'
alias opencode_zai_and_go_qwen_profile='ocx oc -p zai_and_go_qwen'
